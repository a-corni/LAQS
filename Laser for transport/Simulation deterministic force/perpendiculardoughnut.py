...
class GLWidget(QtOpenGL.QGLWidget):
    ...
    def __init__(self, parent=None,smooth=True):
        ...
        data = np.load('D:/Users/Antoine/Documents/copenhague-1/togit/gaussian_forAntoine/solverp0_3D_perpendiculardoughnut.npz',allow_pickle=True)
    ...
    def animate(self):
        ...
        fname = 'D:/Users/Antoine/Documents/copenhague-1/togit/gaussian_forAntoine/perpendiculardoughnut/frame_nb_'+str(self.counter)+'.png'
        image.save(fname)
        self.fbo.release()
