...
def E_pol(z,y,x):
    ...
    beam1 = E(z,y,x-x0)*np.exp(-1j*k*z)*pol
    beam2 = E(z,y,x+x0)*np.exp(-1j*k*z)*pol
    return beam1 + beam2
...
np.savez('D:/Users/Antoine/Documents/copenhague-1/togit/gaussian_forAntoine/solverp0_3D_vgaussian.npz',sol_arr=sol_arr)
print('--done--')
