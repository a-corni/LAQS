...
def derivTx(z,y,x):
    ...
    def f(x):
        return It(z,y,x)
    return derivative(f, x, dx=1e-12)
...
def derivTy(z,y,x):
    ...
    return derivative(f, y, dx=1e-12)
...
def derivTz(z,y,x):
    ...
    return derivative(f, z, dx=1e-12)
...
np.savez('D:/Users/Antoine/Documents/copenhague-1/togit/gaussian_forAntoine/solverp0_3D_gaussian_grad.npz',sol_arr=sol_arr)
print('--done--')
