...
def E_pol(z,y,x):
    pol = np.array([0,1/np.sqrt(2),1/np.sqrt(2)])
    return E(z,y,x)*np.exp(-1j*k*z)*pol
...
# Constructs a QGLFormat object with the following default settings:
    ...
    # Multisample buffers: Disabled
        ...
        data = np.load('D:/Users/Antoine/Documents/copenhague-1/togit/gaussian_forAntoine/solverp0_3D_gaussian_polarization.npz',allow_pickle=True)
