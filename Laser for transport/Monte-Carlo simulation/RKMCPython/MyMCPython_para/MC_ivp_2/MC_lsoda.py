import numpy as np
from .integrate_ode import ode
from .MCcommon import validate_tol, validate_first_step, warn_extraneous
from .MCbase import OdeSolver, DenseOutput
...
class LSODA(OdeSolver):
    ...
    .. [2] L. Petzold, "Automatic selection of methods for solving stiff and
           ...
           1983.
    """
    def __init__(self, fun, fun_scattering, proba_scattering, t0, y0, t_bound, first_step=None, min_step=0.0, max_step=np.inf, rtol=1e-3, atol=1e-6, jac=None, lband=None, uband=None, vectorized=False, **extraneous):
        warn_extraneous(extraneous)
        super(LSODA, self).__init__(fun, fun_scattering, proba_scattering, t0, y0, t_bound, vectorized)
