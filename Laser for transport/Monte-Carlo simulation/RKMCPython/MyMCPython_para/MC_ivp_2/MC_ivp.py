import inspect
import numpy as np
from .MC_rk import RK45, RK23, DOP853
from .MC_optimize import OptimizeResult
from .MC_common import EPS, OdeSolution
from .MC_base import OdeSolver


METHODS = {'RK45': RK45, 'RK23': RK23, 'DOP853':DOP853}
...
def solve_ivp(fun, fun_scattering, proba_scattering, t_span, y0, method='RK45', t_eval=None, dense_output=False, events=None, vectorized=False, args=None, **options):
    ...
    solver = method(fun, fun_scattering, proba_scattering, t0, y0, tf, vectorized = vectorized, **options)
