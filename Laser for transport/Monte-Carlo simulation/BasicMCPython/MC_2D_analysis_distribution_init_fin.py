...
dt_min = 1/(nb_samples)*tend2 # 0.25% of simulation time
print("tend1 (in s) :", tend1*tL)
print("tend2, dt_min (in s): ", tend2*tL, dt_min*tL)
print("Maximum number of scattering for 1 atom during the simulation ", gamma_scatter_max*tend2*tL/2/np.pi)
print("Maximum number of scattering for 1 atom between two samples ", gamma_scatter_max*dt_min*tL/2/np.pi)
...
distribution_init_z = [sol_arr[6*i+1, 0]*L for i in range(nb_part)]
distribution_init_y = [sol_arr[6*i+3, 0]*L for i in range(nb_part)]
distribution_init_x = [sol_arr[6*i+5, 0]*L for i in range(nb_part)]
distribution_init_vz = [sol_arr[6*i, 0]*vL for i in range(nb_part)]
distribution_init_vy = [sol_arr[6*i+2, 0]*vL for i in range(nb_part)]
distribution_init_vx = [sol_arr[6*i+4, 0]*vL for i in range(nb_part)]
...
distribution_final_z = [sol_arr[6*i+1, nb_iter-1]*L for i in range(nb_part)]
distribution_final_y = [sol_arr[6*i+3,nb_iter-1]*L for i in range(nb_part)]
distribution_final_x = [sol_arr[6*i+5, nb_iter-1]*L for i in range(nb_part)]
distribution_final_vz = [sol_arr[6*i, nb_iter-1]*vL for i in range(nb_part)]
distribution_final_vy = [sol_arr[6*i+2, nb_iter-1]*vL for i in range(nb_part)]
distribution_final_vx = [sol_arr[6*i+4, nb_iter-1]*vL for i in range(nb_part)]
