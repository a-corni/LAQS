...
w0 = 2e-3 #m # waist 1/e^2 intensity radius
...
class GLWidget(QtOpenGL.QGLWidget):
    ...
    def __init__(self, parent=None,smooth=True):
        ...
        data = np.load('D:/Users/Antoine/Documents/copenhague-1/togit/gaussian_forAntoine/center_mass_'+simulation_name+'.npz',allow_pickle=True)
    ...
    def animate(self):
        ...
        fname = 'D:/Users/Antoine/Documents/copenhague-1/togit/gaussian_forAntoine/doughnut/'+simulation_name+'_frame_nb_'+str(self.counter)+'.png'
        image.save(fname)
        self.fbo.release()
    ...
    def paintGL(self):
        ...
        GL.glLoadIdentity()
        GL.glTranslatef(self.center_mass[self.counter%self.nbframes],-5.0,-200.0) #camera set at y = -5, x = -50
