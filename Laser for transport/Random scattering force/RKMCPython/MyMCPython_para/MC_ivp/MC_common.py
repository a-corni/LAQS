...
def warn_extraneous(extraneous):
    ...
    """
    if extraneous:
        warn("The following arguments have no effect for a chosen solver: {}.".format(", ".join("`{}`".format(x) for x in extraneous)))
...
def select_initial_step(fun, t0, y0, f0, proba_scatter0, direction, order, rtol, atol):
    ...
    return min(100 * h0, h1, 0.1*proba_scatter0)
