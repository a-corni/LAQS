...
class OdeSolver(object):
    ...
    def __init__(self, fun, fun_scattering, proba_scattering, t0, y0, t_bound, vectorized, support_complex=False):
        
        self.t_old = None
        self.t = t0
        self._fun, self._fun_scattering, self._proba_scattering, self.y = check_arguments(fun, fun_scattering, proba_scattering, y0, support_complex)
        ...
        self.proba_scattering = proba_scattering
