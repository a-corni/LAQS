...
def It0(z,y,x):
    ...
    return U0*(2*np.math.factorial(p)/np.pi/np.math.factorial(p+l))*(w0/w(z))**2*(2*r_w_z_2)**l*np.exp(-2*r_w_z_2)*eval_genlaguerre(p,l,2*r_w_z_2)**2
...
class GLWidget(QtOpenGL.QGLWidget):
    ...
    def __init__(self, parent=None,smooth=True):
        ...
        data = np.load('D:/Users/Antoine/Documents/copenhague-1/togit/gaussian_forAntoine/solverp0_3D_gaussian_final.npz',allow_pickle=True)
    ...
    def animate(self):
        ...
        fname = 'D:/Users/Antoine/Documents/copenhague-1/togit/gaussian_forAntoine/gaussian/frame_nb_'+str(self.counter)+'.png'
        image.save(fname)
        self.fbo.release()
