...
#simulation to run
simulation_name = "doughnut_0.5_100_10"
...
w0 = 0.5e-3 #m # waist 1/e^2 intensity radius
...
distribution_init_z = [sol_arr[i].y[1,0]*L for i in range(nb_part[0])]
distribution_init_y = [sol_arr[i].y[3,0]*L for i in range(nb_part[0])]
distribution_init_x = [sol_arr[i].y[5,0]*L for i in range(nb_part[0])]
distribution_init_vz = [sol_arr[i].y[0,0]*vL for i in range(nb_part[0])]
distribution_init_vy = [sol_arr[i].y[2,0]*vL for i in range(nb_part[0])]
distribution_init_vx = [sol_arr[i].y[4,0]*vL for i in range(nb_part[0])]
...
plt.suptitle('Initial distribution of the speed of the cloud of '+str(nb_part[0])+' atoms')
plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/gaussian_forAntoine/doughnut/distr_init_v'+simulation_name+'.png')
...
plt.subplots_adjust(hspace = 0.5)
plt.suptitle('Initial position distribution of the cloud of '+str(nb_part[0])+' atoms')
plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/gaussian_forAntoine/doughnut/distr_init_pos'+simulation_name+'.png')


#take the final distributions
distribution_final_z = [sol_arr[i].y[1,nb_iter-1]*L for i in range(nb_part[0])]
distribution_final_y = [sol_arr[i].y[3,nb_iter-1]*L for i in range(nb_part[0])]
distribution_final_x = [sol_arr[i].y[5,nb_iter-1]*L for i in range(nb_part[0])]
distribution_final_vz = [sol_arr[i].y[0,nb_iter-1]*vL for i in range(nb_part[0])]
distribution_final_vy = [sol_arr[i].y[2,nb_iter-1]*vL for i in range(nb_part[0])]
distribution_final_vx = [sol_arr[i].y[4,nb_iter-1]*vL for i in range(nb_part[0])]
...
plt.subplots_adjust(hspace = 0.5)
plt.suptitle('Final speed distribution of the cloud of ' + str(nb_part[0])+' atoms')
plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/gaussian_forAntoine/doughnut/distr_fin_v'+simulation_name+'.png')
...
plt.subplots_adjust(hspace = 0.5)
plt.suptitle('Final distribution of the position of the cloud of '+str(nb_part[0])+' atoms')
plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/gaussian_forAntoine/doughnut/distr_fin_pos'+simulation_name+'.png')
...
if nb_part>0:
    ...
    plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/gaussian_forAntoine/doughnut/distr_fin_v_filtered'+simulation_name+'.png')
    ...
    plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/gaussian_forAntoine/doughnut/distr_fin_pos_filtered'+simulation_name+'.png')
