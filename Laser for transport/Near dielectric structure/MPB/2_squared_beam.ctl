...
(define-param large 0.2) ; micro-m 
(define-param long 0.5); micro-m
(define-param empty 0.25); micro-m
...
(set! geometry(list (make block (center (- (- (/ empty 2)) (/ long 2)) 0 0)(size long large infinity)(e1 1 0 0)(e2 0 1 0)(e3 0 0 1)(material (make dielectric (index n1)))) (make block (center (+ (/ empty 2) (/ long 2)) 0 0)(size long large infinity)(e1 1 0 0)(e2 0 1 0)(e3 0 0 1)(material (make dielectric (index n1)))))) ; generate square beam
