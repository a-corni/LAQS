...
(set! geometry(list (make cylinder(center 0.5 0 0)(radius rad)(height infinity)(axis 0 0 1)(material (make dielectric (index n1))))
(make cylinder(center 0.5 0 0)(radius rad)(height infinity)(axis 0 0 1)(material (make dielectric (index n1)))))) ; generate nanofiber
