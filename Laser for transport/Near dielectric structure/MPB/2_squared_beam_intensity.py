...
filename = 'D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_squared_beam-epsilon.h5'  
...
filename = 'D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_squared_beam-e.k01.b01.yodd.780.h5'  
...
filename = 'D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_squared_beam-flux.v.k01.b01.z.yodd.780.h5'  
...
filename = 'D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_squared_beam-tot.rpwr.k01.b01.yodd.780.h5'  
...
plt.tight_layout()
plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_squared_beam_780_light_intensity.png')
...
filename = 'D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_squared_beam-e.k01.b01.yeven.1057.h5'  
...
#load Poynting data and energy density to compute group velocity
filename = 'D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_squared_beam-flux.v.k01.b01.z.yeven.1057.h5'  
...
#load total energy density 
filename = 'D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_squared_beam-tot.rpwr.k01.b01.yeven.1057.h5'  
...
plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_squared_beam_1beam_1057_Electric_intensity.png')
...
cbar.set_label('Light Intensity [in W.m-2]',rotation=270,labelpad=20)
plt.tight_layout()
plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_squared_beam_1057_light_intensity.png')
# cmap = plt.cm.hot
# norm = plt.Normalize()
# image = cmap(norm(Ib))
...
for i,x in enumerate(xp):
    for j,y in enumerate(yp):
        test1x = (abs(xp[i])<r0)
        test1y = (abs(yp[j]-1)<r0)
        if test1x and test1y:
            Nanofiber_potential[i,j] = 0
        else:
            if test1x:
                Nanofiber_potential[i,j] -=  (5.6E-49)/(((abs(yp[j]-1)-r0)*1e-6)**3) #add vanderwals
            elif test1y:
                Nanofiber_potential[i,j] -=  (5.6E-49)/(((abs(xp[i])-r0)*1e-6)**3) #add vanderwals potential
            else :
                Nanofiber_potential[i,j] -=  (5.6E-49)/(np.sqrt(((abs(xp[i])-r0)*1e-6)**2 +((abs(yp[j]-1)-r0)*1e-6)**2)**3)
...
plt.tight_layout()
plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_squared_beam_Trap_potential.png')
...
plt.tight_layout()
plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_squared_beam_Trap_force_x.png')
...
plt.tight_layout()
plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_squared_beam_Trap_force_y.png')
...
print("plot4")
plt.legend()
plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_squared_beam_potential_x.png')
...
plt.legend()
plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_squared_beam_potential_y.png')
