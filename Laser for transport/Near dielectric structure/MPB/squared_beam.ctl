...
(define-param side 0.235) ; micro-m 
...
(set! geometry(list (make block (center 0 0 0)(size side side infinity)(e1 1 0 0)(e2 0 1 0)(e3 0 0 1)(material (make dielectric (index n1)))))) ; generate square beam
