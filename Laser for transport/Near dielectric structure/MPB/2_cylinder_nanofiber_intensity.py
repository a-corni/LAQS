...
filename = 'D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_cylinder_nanofiber-epsilon.h5'  
...
filename = 'D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_cylinder_nanofiber-e.k01.b01.yodd.780.h5'  
...
filename = 'D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_cylinder_nanofiber-flux.v.k01.b01.z.yodd.780.h5'  
...
filename = 'D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_cylinder_nanofiber-tot.rpwr.k01.b01.yodd.780.h5'  
...
plt.tight_layout()
plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_cylinder_nanofiber_780_light_intensity.png')
...
filename = 'D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_cylinder_nanofiber-e.k01.b01.yeven.1057.h5'  
...
#load Poynting data and energy density to compute group velocity
filename = 'D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_cylinder_nanofiber-flux.v.k01.b01.z.yeven.1057.h5'  
...
#load total energy density 
filename = 'D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_cylinder_nanofiber-tot.rpwr.k01.b01.yeven.1057.h5'  
...
plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_cylinder_1beam_1057_Electric_intensity.png')
...
cbar.set_label('Light Intensity [in W.m-2]',rotation=270,labelpad=20)
plt.tight_layout()
plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_cylinder_1057_light_intensity.png')
# cmap = plt.cm.hot
# norm = plt.Normalize()
# image = cmap(norm(Ib))
...
for i,x in enumerate(xp):
    for j,y in enumerate(yp):
        ...
        r1 = np.sqrt(xp[i]**2+(yp[j]-1)**2)
        r2 = np.sqrt(xp[i]**2+(yp[j]+1)**2)

        if r1 < r0:
            Nanofiber_potential[i,j] = 0
        else:
            Nanofiber_potential[i,j] -=  (5.6E-49)/(((r1-r0)*1e-6)**3) #add vanderwals potential
        
        if r2 < r0:
            Nanofiber_potential[i,j] = 0
        else:
            Nanofiber_potential[i,j] -=  (5.6E-49)/(((r2-r0)*1e-6)**3) #add vanderwals potential
...
plt.imshow(Nanofiber_potential/kb*1e3, norm = colors.DivergingNorm(vmin=-0.2, vcenter=0, vmax=1.0), cmap=plt.cm.RdYlBu,extent=[xp[0],xp[-1],yp[0],yp[-1]])#,interpolation='none') 
cbar = plt.colorbar() 
cbar.set_label('Trap Potential [in mK]',rotation=270,labelpad=20)
plt.tight_layout()
plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_cylinder_Nanofiber_Trap_potential.png')
...
plt.tight_layout()
plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_cylinder_Nanofiber_Trap_force_x.png')
...
plt.tight_layout()
plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_cylinder_Nanofiber_Trap_force_y.png')
...
print("plot4")
plt.legend()
plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_cylinder_Nanofiber_potential_x.png')
...
plt.legend()
plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/2_cylinder_Nanofiber_potential_y.png')
