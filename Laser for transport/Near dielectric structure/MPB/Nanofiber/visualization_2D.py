...
for i in range(0, nb_iter, 10):
    ...
    py = [sol_arr[j].y[3,i]*1e6 for j in range(nb_part)]
    ...
    cbar.set_label('Trap Potential [in mK]',rotation=270,labelpad=20)
    plt.tight_layout()
    plt.savefig('D:/Users/Antoine/Documents/copenhague-1/togit/MyMCPython/nanofiber_experiment/Nanofiber_Trap_potential'+str(i)+'.png')
